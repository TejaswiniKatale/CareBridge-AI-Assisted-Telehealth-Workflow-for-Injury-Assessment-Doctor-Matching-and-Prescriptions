...
For a research prototype, the following datasets may be prepared:

### Patient Case Dataset

Each patient record may include:

```json
{
  "patient_id": "P001",
  "injury_type": "knee injury",
  "description": "Patient fell while running and reports bleeding and pain.",
  "pain_level": 7,
  "image_path": "data/images/knee_001.jpg",
  "video_path": "data/videos/knee_001.mp4",
  "doctor_specialty_label": "orthopedic",
...
```json
{
  ...
  "description": "I fell while running and my knee is bleeding.",
  "pain_level": 7,
  "video_uploaded": true
}
```
...
```json
{
  ...
  "severity": "moderate",
  "recommended_specialist": "orthopedic doctor",
  "summary": "Patient reports knee injury after falling while running. Visual cues suggest bleeding and reduced movement.",
  "urgent_flags": [
    "bleeding",
    "limited movement"
  ]
...
This project is for academic and research purposes. Add your preferred license here, such as MIT License.
